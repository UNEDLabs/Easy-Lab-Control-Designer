  ...
  protected EkitCore parentEkit;
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(this.isEnabled())
		{
			...
			{
				//SimpleInfoDialog sidWarn = Paco 
				new SimpleInfoDialog(parentEkit.getFrame(), Translatrix.getTranslationString("Error"), true, Translatrix.getTranslationString("ErrorNoTextSelected"), ImageObserver.ERROR);
			}
			else
			{
