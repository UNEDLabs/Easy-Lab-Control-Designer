...
public class WatermarkCollection
{
	...
	private Vector<Watermark> m_watermarks;

	public WatermarkCollection()
	{
        m_watermarks = new Vector<Watermark>();
	}
	...
	{
		for (Enumeration<Watermark> itr = m_watermarks.elements();itr.hasMoreElements();)
		{
			Watermark wm = itr.nextElement();
