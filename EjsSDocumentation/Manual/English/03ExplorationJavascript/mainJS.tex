...
mass and spring user interface. Notice that the simulation has three main panels, \code{labelPanel}, \code{centerPanel} and \code{bottomPanel}, that appear tiled vertically on the browser's HTML page. These panels belong to the class of \emph{container} elements whose primary
