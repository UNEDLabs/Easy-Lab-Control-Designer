...
public class DifferentiableFunctionElement extends AbstractModelElement {
  static private ImageIcon ELEMENT_ICON = AbstractModelElement.createImageIcon("org/colos/ejs/model_elements/apache_numerics/DifferentiableFunction.gif"); // This icon is included in this jar
  ...
  static private final String DEFAULT_VALUE_CODE = "public double value(double x) { // Define the 'value' function here\n  return x;\n}";
  static private final String DEFAULT_DERIVATIVE_CODE = "public double value(double x) { // Define the derivative's 'value' function here\n  return 1;\n}";
  ...
  private ModelElementSplitEditor mFunctionEditor; // The editor for the code
  ...
  {
    mFunctionEditor = new ModelElementSplitEditor(this,null,"Apache", "DifferentiableFunction", "Function", "Derivative");
    mFunctionEditor.readPlainCode(DEFAULT_VALUE_CODE,DEFAULT_DERIVATIVE_CODE);
  }
  ...
  public String getGenericName() { return "DiffFunction"; }
  
  public String getConstructorName() { return "org.colos.ejs.model_elements.apache_numerics.DifferentiableFunction"; }
  
  @Override
  public String getInitializationCode(String _name) {
    StringBuffer buffer = new StringBuffer();
    buffer.append(_name + " = new " + getConstructorName() + "(new org.apache.commons.math3.analysis.DifferentiableUnivariateFunction() {\n");
    buffer.append(mFunctionEditor.getTopEditor().generateCode(_name, "  "));
    buffer.append("\n\n");
    buffer.append("  public org.apache.commons.math3.analysis.UnivariateFunction derivative() {\n");
    buffer.append("    return new org.apache.commons.math3.analysis.UnivariateFunction() {\n");
    buffer.append(mFunctionEditor.getBottomEditor().generateCode(_name, "      "));
    buffer.append("\n    };\n");
    buffer.append("  }\n");
    buffer.append("});\n");
  ...
  public String savetoXML() {
    StringBuffer buffer = new StringBuffer();
    buffer.append(mFunctionEditor.saveStringBuffer());
  ...
  public void readfromXML(String _inputXML) {
    mFunctionEditor.readXmlString(_inputXML);
  ...
  @Override
  public String getTooltip() { return "defines a differentiable y = f(x) function with some utilities"; }
  
  @Override
  public void setFont(Font font) { mFunctionEditor.setFont(font); }

  protected String getHtmlPage() { return "org/colos/ejs/model_elements/apache_numerics/DifferentiableFunction.html"; }
  ...
  protected Component createEditor(String name, Component parentComponent, final ModelElementsCollection collection) {
    ...
    ItemListener itemListener = new ItemListener() {
      public void itemStateChanged(ItemEvent arg0) { collection.reportChange(DifferentiableFunctionElement.this); }
    };
    ...
    mSolverCB.addItem(DifferentiableFunction.SOLVER_NEWTON);
    ...
    mainPanel.add(mFunctionEditor.getComponent(collection, null),BorderLayout.CENTER);
  ...
  public java.util.List<ModelElementSearch> search (String info, String searchString, int mode, String name, ModelElementsCollection collection) {
    return mFunctionEditor.search(info, searchString, mode, name, collection);
  }
