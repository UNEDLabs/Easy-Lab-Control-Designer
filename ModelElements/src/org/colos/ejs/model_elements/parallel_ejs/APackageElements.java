...
public class APackageElements {
  ...
  static public void main(String[] args) {
    String commandLine = 
      " -o ../Ejs/distribution/bin/extensions/model_elements/ParallelJava/parallel_ejs.jar " + // The output JAR file, to be located under in bin/extensions/model_elements
//      " -m .;../../ejs.jar;../../ejs_lib.jar;../../osp.jar org.colos.ejs.model_elements.input_output.DataReaderElement "+ // To display something and also for EJS to know the main class
      ...
      " org/colos/ejs/model_elements/parallel_ejs/++ edu/rit/++ "; // get ALL files under this directory and its dependencies (for class files)
