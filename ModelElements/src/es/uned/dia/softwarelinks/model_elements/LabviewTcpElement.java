...
import es.uned.dia.softwarelinks.labview.protocol.tcp.Labview;

public class LabviewTcpElement extends AbstractModelElement {
	...
	static ImageIcon FILE_ICON = AbstractModelElement.createImageIcon("data/icons/openSmall.gif"); // This icon is bundled with EJS
	...
	public String getConstructorName() { return "es.uned.dia.softwarelinks.labview.protocol.tcp.Labview"; }// se mantiene HVO
