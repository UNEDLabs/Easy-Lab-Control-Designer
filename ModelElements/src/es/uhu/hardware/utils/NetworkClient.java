...
/*
  NetworkClient - basic network client implementation
 ...
 * @instanceName client any variable of type NetworkClient
 * @usage Application
 */
...
//  private PApplet parent;
  ...
  private Method disconnectEventMethod;
...
//                                      new Class[] { NetworkClient.class });
//      } catch (Exception e) {
//        // no such method, or an error.. which is fine, just ignore
//      }
//      // do the same for disconnectEvent(NetworkClient c);
//      try {
...
//      }
  ...
  /**
   * Disconnects from the server. Use to shut the connection when you're finished with the NetworkClient.
   * =advanced
   * Disconnect from the server and calls disconnectEvent(NetworkClient c)
   * in the host PApplet.
   * <P/>
  ...
  /**
   * Returns the IP address of the computer to which the NetworkClient is attached.
   ...
   * @throws IOException 
   */
  public void write(int data) throws IOException {  // will also cover char
  ...
  */
  ...
  //parent.die("Error inside NetworkClient." + where + "()", e);
