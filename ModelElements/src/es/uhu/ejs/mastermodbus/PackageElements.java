...
public class PackageElements {
  ...
  static public void main(String[] args) {
    String commandLine = 
      " -o ../Ejs/distribution/bin/extensions/model_elements/External/mastermodbussarlab.jar " + // The output JAR file, to be located under in bin/extensions/model_elements
//      " -m .;../../ejs.jar;../../ejs_lib.jar;../../osp.jar org.colos.ejs.model_elements.input_output.DataReaderElement "+ // To display something and also for EJS to know the main class
      ...
      " es/uhu/ejs/mastermodbus/++ "; // get ALL files under this directory and its dependencies (for class files)
