...
public class PackageElements {
  ...
  static public void main(String[] args) {
    String commandLine = 
        " -o ../Ejs/distribution/bin/extensions/model_elements/InputOutput/ARSystem.jar " +// The output JAR file, to be located under in bin/extensions/model_elements
//            " -o ../../EJS/EJS_EXP_AR/EJS_4.3.7/bin/extensions/model_elements/Hardware/ARSystem.jar " +
            ...
            " -c ../Ejs/distribution/bin/extensions/model_elements/InputOutput/_utils/gstreamer-java.jar " + 
            " -c ../Ejs/distribution/bin/extensions/model_elements/InputOutput/_utils/jna.jar " + 
//            " -c ../Ejs/distribution/bin/extensions/model_elements/Hardware/_utils/GSVideo.jar " + 
            ...
            " -x ../Ejs/distribution/bin/extensions/model_elements/InputOutput/_utils/gstreamer-java.jar " + 
            " -x ../Ejs/distribution/bin/extensions/model_elements/InputOutput/_utils/jna.jar " + 
//            " -x ../Ejs/distribution/bin/extensions/model_elements/Hardware/_utils/GSVideo.jar " +
            ...
            " -x es/uhu/PackageElements.class"+ // do not include these classes
            " es/uhu/ejs/augmented_reality/++ es/uhu/augmented_reality/++ "; // get ALL files under these directories and its dependencies (for class files)
